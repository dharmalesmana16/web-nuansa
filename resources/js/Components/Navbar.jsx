                            ...
                            <ul className="navbar-nav mx-auto mb-2 mb-lg-0 ">
                                ...
                                <li className="nav-item dropdown px-3">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><a className="dropdown-item" href="/product/cctv">CCTV</a></li>
                                        <li><a className="dropdown-item" href="/product/pabx">PABX</a></li>
                                        <li><a className="dropdown-item" href="/product/iot">Internet of Things</a></li>
                                        <li><a className="dropdown-item" href="/product/videotron">Videotron/Running Text</a></li>
                                    </ul>
                                </li>
                                <li className="nav-item dropdown px-3">
                                    <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
