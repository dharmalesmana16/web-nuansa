...
export default function UpdateNews(props) {
    ...
    const handleCreate = async (e) => {
        e.preventDefault();
        const data = { "nama": nama, "description": description, "user_id": datas.auth.user.id };
        if (gambar !== null) {
            data["photo"] = gambar
        }
        try {
            await axios.post(`/dashboard/news/update/${props.data.id}`, data, {
                        ...
                        <form className="row g-3" encType="multipart/form-data" onSubmit={handleCreate} >
                            ...
                            <div className="row ">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <img src={previewImg ? previewImg : `/storage/news/${props.data.photo}`}
                                        className="" alt="..." style={{
