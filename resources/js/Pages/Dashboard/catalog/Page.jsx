...
export default function Page(props) {
    ...
    function handleDelete(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.delete("/dashboard/catalog/" + slug).then((response) => {
                    Swal.fire({
                        icon: "success",
                        title: "Success",
                        timer: 3000
    ...
    const columns = [
        ...
        {
            name: 'Kategori',
            selector: row => row.category_product_id,
        },

        {
            name: 'Action',
            selector: row => <div className='d-flex '>
                <a href={`/dashboard/catalog/edit/${row.slug}`} className='btn btn-sm btn-primary p-2'>Edit</a>
    ...
    return (
        <DashboardLayout user={props.user}>
            <div className="text-end py-2">
                <a href="/dashboard/catalog/new" className='btn btn-md btn-success'>Add New Data</a>
            </div>
